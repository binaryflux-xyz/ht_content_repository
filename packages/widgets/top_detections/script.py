...
def configure():
    return {
        ...
        "filters":['hindustantimes/hindustantimes/widgetfilters/criticality_filter/','hindustantimes/hindustantimes/widgetfilters/tactic_filter/',
                   'hindustantimes/hindustantimes/widgetfilters/technique_filter/','hindustantimes/hindustantimes/widgetfilters/stream_filter/'],
